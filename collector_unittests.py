...
class CollectorTests(unittest.TestCase):
    ...
    action_space = 4
    gamma = .99
    collector = Collector(n_envs=n_envs, grid_size=grid_size, n_foods=n_foods, unit_size=unit_size, n_state_frames=n_state_frames, net=None, n_tsteps=n_tsteps, env_type=env_type, preprocessor=model.Model.preprocess)
    ...
    def test_preprocess(self):
        collector = Collector(n_envs=self.n_envs, grid_size=self.grid_size, n_foods=self.n_foods, unit_size=self.unit_size, n_state_frames=self.n_state_frames, net=self.net, n_tsteps=self.n_tsteps, env_type=self.env_type, preprocessor=model.Model.preprocess)
